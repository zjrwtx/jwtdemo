...
const LoginModal = ({ onLoginSuccess }) => {
  ...
  const handleLogin = async (data) => {
    try {
      const userCheckResponse = await axios.post(process.env.REACT_APP_auth_API_URL+'/check_user', {
      ...
      const response = await axios.post(process.env.REACT_APP_auth_API_URL+'/token', qs.stringify({
        username: data.username,
  ...
  const handleRegister = async (data) => {
    ...
    try {
      await axios.post(process.env.REACT_APP_auth_API_URL+'/register', {
        username: data.username,
        email: data.email,
        password: data.password,
      });
