...
const App = () => {
  ...
  return (
    ...
    <Toolbar>
      ...
      <Button color="inherit" component={Link} to="/mindmap">思维导图生成</Button>
      <Button color="inherit" component={Link} to="/Watchmindmap">实时编辑思维导图</Button>
      <Button color="inherit" component={Link} to="/SubscriptionPlans">升级vip</Button>
